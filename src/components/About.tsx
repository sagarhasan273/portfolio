...
const values = [
  {
    ...
    title: "Fast Learner",
    description:
      "Quickly adapts to new technologies, frameworks, and architectural patterns.",
    checkout: undefined,
  },
  {
    icon: Users,
    title: "Team Player",
    description:
      "Cross-functional collaboration, clean code culture, and shared ownership.",
    checkout: undefined,
  },
  {
    icon: Target,
    ...
    description:
      "Measurable improvements in performance, scalability, and user experience.",
  },
  {
    icon: Brain,
    title: "Problem Solver",
    description:
      "Structured thinking, strong DSA foundations, and scalable system design principles.",
  },
];

const stats = [
  { value: "~500", label: "Active Users (Peak)" },
  { value: "3", label: "Apps in Production" },
  { value: "100%", label: "Self-taught & Shipping" },
];
            ...
            <Box sx={{ position: "relative" }}>
              ...
              >
                ...
                <Box sx={{ position: "absolute", bottom: 20, left: 20 }}>
                  <Typography
                    sx={{ fontWeight: 700, color: "#F9FAFB", fontSize: "1rem" }}
                  >
                    Sagar Hasan
                  </Typography>
                  <Typography sx={{ fontSize: "0.8rem", color: "#007AFF" }}>
              ...
              >
                <Typography
                  sx={{ fontWeight: 700, fontSize: "1.3rem", color: "#007AFF" }}
                >
                  1200+
                </Typography>
                <Typography
          ...
          {values.map((v, i) => (
            <Grid item xs={12} sm={6} md={3} key={i}>
              ...
              >
                ...
                <Typography
                  sx={{ fontSize: "0.8rem", color: "#6B7280", lineHeight: 1.6 }}
                >
                  {v.description}
                </Typography>
              </Paper>
